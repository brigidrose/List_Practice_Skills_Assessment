...
def print_list(items):
    ...
    #print("the wrong thing") #What is the deal with this??? 
                             #I just wound up leaving it out.
...
def smallest_int(numbers):
    ...
    **DO NOT USE** the built-in function `min()`!
    ...
    If the input list is empty, return `None`::
        ...
        True
    """
    numbers.sort()          #kind of unclear about diff between sort and sorted
...
def halvesies(numbers):
    ...
    num_list = []
    for nums in numbers:
        num_list.append(nums/float(2)) #looked at Stackoverflow for float division syntax
    return num_list                    #this looks really weird. Is there a better way?
...
def reverse_list(items):
    ...
    **Do not use** the python function `reversed()` or the method
    ...
    You should do this without changing the original list::
        ...
        ['apple', 'berry', 'cherry']
    """
    #for items in range(-1, 0, 1):
    return items[::-1]     #need to review the syntax of this. I had to do
...
def reverse_list_in_place(items):
    ...
    **Do not use** the python function `reversed()` or the method
    ...
    #I have been programming for 5 hours straight. I am so brain dead.
...
def find_letter_indices(words, letter):
    ...
    **DO NOT** use the `list.index()` method.
    ...
    #I think I could probably figure this out, but I have spent
    # a cumulative amount of 8 hours on my homework and my brain is sooo dead.
